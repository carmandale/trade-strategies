...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    # Drop indexes first
    op.drop_index('idx_market_cache_expires', table_name='market_data_cache')
    op.drop_index('idx_market_cache_symbol_date', table_name='market_data_cache')
    ...
    op.drop_index('idx_strategies_params', table_name='strategies')
