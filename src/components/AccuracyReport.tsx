...
import { CheckCircle, XCircle, AlertCircle, ChevronDown, ChevronUp, TestTube, Calculator } from 'lucide-react';
import { verifier, VerificationResult } from '../utils/accuracyVerification';
import runEdgeCaseTests from '../utils/edgeCaseTests';
import runGreeksTests from '../utils/greeksTests';
          ...
          <div className="mt-3 space-y-2">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 bg-purple-700/50 hover:bg-purple-600/50 text-purple-300 text-xs py-1 px-2 rounded transition-all flex items-center justify-center gap-1"
              >
            ...
            <button
              ...
              className="w-full bg-slate-700/50 hover:bg-slate-600/50 text-slate-300 text-xs py-1 px-2 rounded transition-all"
            >
              Clear Results
            </button>
          </div>
